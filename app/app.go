...
import (
	...
	questmodule "quest/x/quest"
	questmodulekeeper "quest/x/quest/keeper"
	questmoduletypes "quest/x/quest/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "quest"
	Name                 = "quest"
)
...
type App struct {
	*baseapp.BaseApp
	...
	QuestKeeper questmodulekeeper.Keeper
...
func New(
	...
	app.QuestKeeper = *questmodulekeeper.NewKeeper(
		appCodec,
		keys[questmoduletypes.StoreKey],
		keys[questmoduletypes.MemStoreKey],
		app.GetSubspace(questmoduletypes.ModuleName),
	)
	questModule := questmodule.NewAppModule(appCodec, app.QuestKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(questmoduletypes.ModuleName)
